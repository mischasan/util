...
//  revbit64(u64)           - reverse bit order in 64bit word
...
#if defined(_POSIX_C_SOURCE) && !defined(_ANSI_SOURCE) && !defined(_DARWIN_C_SOURCE) && !defined(__BSD_VISIBLE)
...
static inline uint32_t revbit32(uint32_t u)
{
...
static inline uint64_t revbit64(uint64_t u)
{
