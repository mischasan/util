...
namespace TAP {
	...
	template<typename T, typename U> typename boost::disable_if<typename boost::is_floating_point<U>::type, bool>::type is(const T& left, const U& right, const std::string& message = "") throw () {
		try {
	...
	template<typename T, typename U> typename boost::disable_if<typename boost::is_floating_point<U>::type, bool>::type isnt(const T& left, const U& right, const std::string& message = "") throw() {
		try {
	...
	template<typename T, typename U> typename boost::enable_if<typename boost::is_floating_point<U>::type, bool>::type is(const T& left, const U& right, const std::string& message = "", double epsilon = 0.01) throw() {
		try {
	...
	template<typename T, typename U> typename boost::enable_if<typename boost::is_floating_point<U>::type, bool>::type isnt(const T& left, const U& right, const std::string& message = "", double epsilon = 0.01) throw() {
		try {
	...
	template<typename T, typename U> bool is_convertible(const std::string& message) throw() {
		return ok(boost::is_convertible<T, U>::value, message);
	}

	template<typename T, typename U> bool is_inconvertible(const std::string& message) throw() {
		return ok(!boost::is_convertible<T, U>::value, message);
	}
...
/*
 * Everything below this line is highly experimental.
 */
